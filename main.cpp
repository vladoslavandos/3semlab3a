...
void print_diagram(Diagram& diagram) {diagram.output(std::cout);}
...
void add_diagram(Diagram& diagram)
{
    ...
    try
    {
        diagram.add(other).output(std::cout << "Resolved diagram: \n");
    }
    catch(std::runtime_error& e)
    {
        std::cerr << e.what() << std::endl;
...
void replace_diagram_part(Diagram& diagram)
{
    ...
    try
    {
        diagram.replace(ts, other).output(std::cout << "Resolved diagram: \n");
    }
    catch(std::runtime_error& e)
    {
        std::cerr << e.what() << std::endl;
...
void repeat_diagram(Diagram& diagram)
{
    ...
    try
    {
        diagram.repeat(n).output(std::cout << "Resolved diagram: \n");
    }
    catch(std::runtime_error& e)
    {
        std::cerr << e.what() << std::endl;
...
void lshift_diagram(Diagram& diagram)
{
    ...
    try
    {
        diagram.lshift(ts).output(std::cout << "Resolved diagram: \n");
    }
    catch(std::runtime_error& e)
    {
        std::cerr << e.what() << std::endl;
...
void rshift_diagram(Diagram& diagram)
{
    ...
    try
    {
        diagram.rshift(ts).output(std::cout << "Resolved diagram: \n");
    }
    catch(std::runtime_error& e)
    {
        std::cerr << e.what() << std::endl;
